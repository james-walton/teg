 ...
 * particular, you can set here the values of variables elements defined in teg_teg.tpl (elements
...
class view_teg_teg extends game_view
{
	protected function getGameName()
	{
  	...
  	{		
		...
		*/
		...
		$this->page->begin_block( "teg_teg", "myblock" );
